...
dag = DAG(
    'production_database_clone_and_import',
...
clone_db_task_production = PythonOperator(
    task_id='clone_database_production',
...
update_supplier_send_setting = PythonOperator(
    task_id='update_data_supplier',
    python_callable=update_data_supplier,
    dag=dag,
)

# Define task dependencies
clone_db_task_production >> create_db_task >> import_sql_task >> unlink_file_downloaded >> update_supplier_send_setting
